...
const Contact = () => {
    ...
    return (
        <div className='px-10'>
            <Helmet>
                <title>TripsTravel | Contract</title>
                <meta name="description" content="Helmet application" />
            </Helmet>

            <section
                className="relative z-5 overflow-hidden bg-white dark:bg-[#111928] py-5 min-h-screen"
            >
                    ...
                    <div className="flex flex-wrap -mx-4 lg:justify-between">
                        <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                            <div className="mb-12 max-w-[570px] lg:mb-0">
                                ...
                                <p
                                    className="text-base leading-relaxed text-body-color dark:text-white mb-9"
                                >
                                ...
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    <div
                                        className="bg-primary/5 text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center dark:text-white justify-center overflow-hidden rounded sm:h-[70px] sm:max-w-[70px]"
                                    >
                                        <svg
                                            width="32"
                                            height="32"
